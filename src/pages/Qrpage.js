                ...
                loading ? (
                    ...
                    <Transition.Root show={sideBar} as={Fragment}>
                                    ...
                                    <div className="pt-9 pb-3 relative flex-1 px-4 md:pt-6 sm:px-6 sm:pt-3">
                                        {
                                            ...
                                            <div className="px-5 flex-col">
                                                ...
                                                <input className="w-full rounded-full bg-gray-200 px-3 py-1 my-2 outline-none new-table" 
                                            ...
                                            : <div className="px-5 flex-col">
                                                <p className="px-3 mt-2">Table No: </p>
                                                <input className="w-full rounded-full bg-gray-200 px-3 py-1 my-2 outline-none update-table" 
                        ...
                        <div className="flex w-4/5 mx-auto pt-5">
                            ...
                            className="bg-white px-4 py-3 rounded-full flex">
                                <PlusCircle className="w-6 h-6 mr-2"/>
                                Create
                            </button>
                        </div>
                        <h3 className="w-4/5 py-4 px-6 mx-auto font-bold">Restaurant</h3>
                        <section className="w-4/5 mx-auto grid grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
                            <div className="bg-white h-auto rounded-2xl m-3">
                        ...
                        <h3 className="w-4/5 py-4 px-6 mx-auto font-bold">Table</h3>
                        <section className="w-4/5 mx-auto grid grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
                            {
                                generateData.map((data, index) => {
                                    return <div key={index} className="bg-white h-auto rounded-2xl m-3 pb-5 relative overflow-hidden">
                                    <div className="w-full h-auto text-sm pt-2 font-semibold rounded-t-2xl flex justify-center items-center">
                                        <img className="w-10 h-10 rounded-full m-1" src={userDetail.user_image}/>
                                        <h4 className="m-1 font-serif">{userDetail.user_restaurant}</h4>
                                    </div>
                                    ...
                                    ease-in-out duration-700 hover:translate-y-0">
                                        ...
                                        <div className="w-full flex">
                                            ...
                                            <button className="w-1/2 text-center rounded-2xl py-2 text-gray-700 hover:bg-gray-300 hover:text-gray-900">
                                                Delete
                                            </button>
                                        </div>
                                    </div>
